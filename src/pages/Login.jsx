...
useEffect(() => {
  ...
  useEffect(() => {
    ...
    const handleMouseMove = (e) => {
      if (isPasswordVisible || window.innerWidth < 768) return;
  ...
  const togglePassword = () => {
    ...
    if (!isPasswordVisible) {
      allCharacters.forEach(char => char.classList.add('shy'));
    } else {
      allCharacters.forEach(char => char.classList.remove('shy'));
    }
  };
  ...
  return (
    <div className="login-container">
      {/* Left Side - Characters (той самий код) */}
